...
choicer:
  ...
  while(flag!=0)
  {
     ...
     else
     {
        ...
        if((a+b)%5==0)
        {
           if(m[a+1][b]!='#') co[a+1][b]=m[a+1][b];
           else if(m[a-1][b]!='#') co[a-1][b]=m[a-1][b];
           else if(m[a][b-1]!='#') co[a][b-1]=m[a][b-1];
           else if(m[a][b+1]!='#') co[a][b+1]=m[a][b+1];
        }
        else if((a+b)%3==0)
        {
           ...
           else if(m[a][b+2]!='#') co[a][b+2]=m[a][b+2];
           else if(m[a+2][b]!='#') co[a+2][b]=m[a+2][b];
        }
        printf("\n\n      ");
        for(int j=0;j<c;j++)
        {
